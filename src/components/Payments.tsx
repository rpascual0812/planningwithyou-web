  ...
  return (
    <section id="payments" className="section payments">
      <div className="container text-center">
        ...
        <h2 className="section-title">Powered by Paymongo</h2>
        ...
        <div className="payments__grid">
          <article className="card payments__card">
            ...
            <p>
              Add your credit card to Paymongo when you sign up. Choose monthly
          ...
          <article className="card payments__card payments__card--highlight">
            ...
            <p>
              ...
              pay through Paymongo — you get notified when payment is complete.
            </p>
          </article>
          <article className="card payments__card">
            <div className="payments__icon">🔒</div>
            ...
            <p>
              Card data is handled by Paymongo&apos;s PCI-compliant
